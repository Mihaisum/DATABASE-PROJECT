...
namespace NivelAccesDate
{
    public class AdministrareSpectatori : IStocareSpectatori
    {
        ...
        public List<Spectator> GetSpectatori()
        {
            ...
            var dsSpectatori = SqlDBHelper.ExecuteDataSet("select * from SPECTATORI_SM32b", CommandType.Text);
        ...
        public bool AddSpectator(Spectator s)
        {
            ...
            return SqlDBHelper.ExecuteNonQuery(
                "INSERT INTO SPECTATORI_SM32b VALUES (id_spectator_sm32b.nextval, :Nume, :IdMeci, :NrScaun)", CommandType.Text,
        ...
        public bool DeleteSpectator(Spectator s)
        {
            ...
            return SqlDBHelper.ExecuteNonQuery(
                "DELETE FROM SPECTATORI_SM32b WHERE id = :Id", CommandType.Text,
        ...
        public Spectator GetSpectator(int id)
        {
            ...
            var dsSpectator = SqlDBHelper.ExecuteDataSet("select * from SPECTATORI_SM32b where Id = :Id", CommandType.Text,
        ...
        {
            return SqlDBHelper.ExecuteNonQuery(
                "UPDATE SPECTATORI_SM32b set nume = :Nume, meci = :IdMeci, nr_scaun = :NrScaun where id = " + s.idSpec, CommandType.Text,
                new OracleParameter(":Nume", OracleDbType.NVarchar2, s.numeSpec, ParameterDirection.Input),
                new OracleParameter(":IdMeci", OracleDbType.Int32, s.idMeci, ParameterDirection.Input),
                new OracleParameter(":NrScaun", OracleDbType.Int32, s.nrScaun , ParameterDirection.Input)
            );
