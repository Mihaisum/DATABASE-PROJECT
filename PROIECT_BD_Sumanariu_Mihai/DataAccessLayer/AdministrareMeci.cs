...
namespace NivelAccesDate
{
    public class AdministrareMeci : IStocareMeci
    {
        ...
        public List<Meci> GetMeciuri()
        {
            ...
            var dsMeciuri = SqlDBHelper.ExecuteDataSet("select * from MECI_SM32b", CommandType.Text);
        ...
        public bool AddMeci(Meci m)
        {
            return SqlDBHelper.ExecuteNonQuery(
                "INSERT INTO MECI_SM32b VALUES (id_meci_sm32b.nextval, :TipSport, :NumeEchipa, :Data, :Durata, :Stadion, :PretBilet)", CommandType.Text,
        ...
        public bool DeleteMeci(Meci m)
        {
            ...
            return SqlDBHelper.ExecuteNonQuery(
                "DELETE FROM MECI_SM32b WHERE id = :Id", CommandType.Text,
        ...
        {
            Meci result = null;
            var dsMeci = SqlDBHelper.ExecuteDataSet("select * from MECI_SM32b where Id = :Id", CommandType.Text,
        ...
        {
            return SqlDBHelper.ExecuteNonQuery(
                "UPDATE MECI_SM32b set tip_sport = :TipSport, nume_echipa = :NumeEchipa, data = :Data, durata = :Durata, stadion = :Stadion, pret_bilet :PretBilet where id = " + m.idMeci, CommandType.Text,
                new OracleParameter(":TipSport", OracleDbType.NVarchar2, m.tipSport, ParameterDirection.Input),
                new OracleParameter(":NumeEchipa", OracleDbType.NVarchar2, m.numeEchipa, ParameterDirection.Input),
                new OracleParameter(":Data", OracleDbType.Date, m.dataMeci, ParameterDirection.Input),
                new OracleParameter(":Durata", OracleDbType.Int32, m.durataInOre, ParameterDirection.Input),
